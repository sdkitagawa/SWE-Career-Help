...
9. Se você está procurando por alguma coisa dentro da área de Ciência de Dados eu recomendo que você cheque o website <strong>[swirl](https://swirlstats.com/challenges "Aprenda R, em R.").</strong>
10. E por último mas não menos importante, se você está procurando por algo dentro da área do desenvolvimento de aplicações para dispositivos móveis eu recomendaria que você checasse o <strong>[Flatiron School](https://flatironschool.com/ "Escola online para Desenvolvedores de Aplicações para Dispositivos Móveis").</strong>
